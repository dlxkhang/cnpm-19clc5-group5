...
router.get('/api/product/seller', productController.getProductListSeller) // get list of product for seller
...
router.get('/api/cart/delete', productController.deleteProductFromCart) // delete product from cart
