...
class SignUpRepository {
    suspend fun addNormalAccount(nAccount: SignUp_nAccount_input): SignUp_response?{
    ...
    suspend fun addSellerAccount( sAccount: SignUp_sAccount_input):SignUp_response?{
